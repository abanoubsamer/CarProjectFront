...
// import { Add } from '../Models/AddProduct';
...
//     return this.Api.Post<Response<string>>(Routing.Product.Add, request);
//   }

//   updateProduct(request: UpdateProduct): Observable<Response<string>> {
//     return this.Api.Put<Response<string>>(Routing.Product.Update, request);
//   }
